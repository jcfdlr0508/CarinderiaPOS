                ...
                <div class="header-body text-center mb-7">
                    <div class="row justify-content-center">
                        <div class="col-lg-5 col-md-6">
                            <h1 class="text-white">Elaine, Lee, and Jecie's</h1>
                            <h1 class="text-white">Carinderia</h1>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card bg-yellow shadow border-0">
                        <div class="card-body px-lg-5 py-lg-5">
                            <form method="post" role="form">
                                ...
                                <div class="row mt-3">
                        <div class="col-6">
                            <a href="../customer/forgot_pwd.php" target="_blank" class="text-white"><strong><u>Forgot password?</u></strong></a>
                        </div>
                    </div>
                            </form>
