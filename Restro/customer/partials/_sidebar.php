  ...
  <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-yellow" id="sidenav-main">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="change_profile.php">
              <i class="fas fa-users text-dark"></i> My Profile
            </a>
          </li>
          <li class="nav-item">
        ...
        <hr class="my-3">
        <!-- Heading -->
        <h6 class="navbar-heading text-dark">Reporting</h6>
        <!-- Navigation -->
        <ul class="navbar-nav mb-md-3">
          <li class="nav-item">
            <a class="nav-link" href="orders_reports.php">
              <i class="fas fa-shopping-basket text-dark"></i> My Orders
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="payments_reports.php">
              <i class="fas fa-funnel-dollar text-dark"></i> My Payments
            </a>
          </li>
        </ul>
        <hr class="my-3">
        <ul class="navbar-nav mb-md-3">
          <li class="nav-item">
            <a class="nav-link" href="logout.php">
              <i class="fas fa-sign-out-alt text-dark"></i> Log Out
            </a>
          </li>
        </ul>
      </div>
